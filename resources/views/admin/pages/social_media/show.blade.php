...
@endsection
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-10 fv-row fv-plugins-icon-container">
            <input type="text" name="link" class="form-control  {{$locale!='ar' ? 'ltr':''}}" placeholder="" value="{{isset($item) && $item->link
                                                !=null ? $item->link : old('link') }}" readonly>
            <div class="fv-plugins-message-container invalid-feedback">
                @error($locale.'.link')
                <p class="invalid-feedback text-danger {{$locale=='ar' ? 'text-right rtl':''}}" role="alert">
                    {{ $message }}

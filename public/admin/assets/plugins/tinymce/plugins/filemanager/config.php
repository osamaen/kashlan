...
//   |    |   |    |- plugins
//   |    |   |    |-   |- filemanager
//   |    |   |    |-   |-      |- thumb <- folder of thumb [must have the write permission]

//$base_url = ""; //url base of site if you want only relative url leave empty
$base_url = 'http://' . $_SERVER['HTTP_HOST'];
$upload_dir = '/public/uploads/files/'; // path from base_url to upload base dir
$current_path = '../../../../../../uploads/files/'; // relative path from filemanager folder to upload files folder
$MaxSizeUpload=100; //Mb
//echo $root.$upload_dir;
//**********************
//Image config
//**********************
